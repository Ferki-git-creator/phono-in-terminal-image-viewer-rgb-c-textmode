...
void render_image(unsigned char *img_data, int width, int height, int channels, unsigned char bg_r, unsigned char bg_g, unsigned char bg_b) {
    ...
    // This was removed to prevent interference with complex terminal prompts.
    ...
    // Progress bar is already explicitly disabled.
...
int main(int argc, char **argv) {
    ...
    // Removed: atexit(disable_raw_mode); // No raw mode to disable
